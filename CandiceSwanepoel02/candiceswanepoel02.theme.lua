---------------------------
-- Candice Swanepoel 02 awesomewm theme by Donearm <forod.g@gmail.com>
---------------------------
...
theme.bg_normal     = "#7199ca"
theme.bg_focus      = "#f4f4f4"
theme.bg_urgent     = "#9f9281"
theme.bg_minimize   = "#d9d3c5"

theme.fg_normal     = "#f4f4f4"
theme.fg_focus      = "#7199ca"
theme.fg_urgent     = "#7199ca"
theme.fg_minimize   = "#f4f4f4"
...
theme.wallpaper_cmd = { "feh --bg-scale /mnt/documents/Maidens/img/Wallpapers/CandiceSwanepoel-wallpaper02.jpg"}
